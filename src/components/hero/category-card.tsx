...
const CategoryCard = ({ data }: ProjectCardProps) => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between border-b border-dashed border-gray-500 px-4 py-2 text-sm">
        <span
          className={cn(
            currentCategory === data.category && "text-red-500 underline",
          )}
        >
          {data.id}
        </span>
      ...
      <div>
        <div className="mt-2 flex items-center justify-between px-4 py-2 text-sm text-gray-500">
